...
==============================================================================
    ...
    This file starts the API Logic Server (v 6.04.04, December 17, 2022 21:17:34):
...
app_logger.info(f'Created December 17, 2022 21:17:34 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 6.04.04\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 6.04.04\n'
    if is_docker():
